...
public class BaseMessagePo extends feihua.jdbc.api.pojo.BasePo<String> {
    ...
    public com.feihua.framework.base.modules.message.api.ApiBaseMessagePoService service() {
        return com.feihua.utils.spring.SpringContextHolder.getBean(com.feihua.framework.base.modules.message.api.ApiBaseMessagePoService.class);
    }

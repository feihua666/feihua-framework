...
public class WeixinMenuController extends SuperController {
    ...
    public ResponseEntity add(AddWeixinMenuFormDto addFormDto){
        ...
        apiWeixinMenuPoService.preInsert(basePo,getLoginUser().getId());
    ...
    public ResponseEntity update(@PathVariable String id, UpdateWeixinMenuFormDto updateFormDto){
        ...
        apiWeixinMenuPoService.preUpdate(basePo,getLoginUser().getId());
    ...
    private Menu generateMenu(String which){
        Menu menu = null;
        ...
        List<WeixinMenuDto> firstWeixinMenuDtos = apiWeixinMenuPoService.selectList(condition);
        ...
        if (firstWeixinMenuDtos != null && !firstWeixinMenuDtos.isEmpty()) {
            ...
            for (WeixinMenuDto rootWeixinMenuDto : firstWeixinMenuDtos) {
                ...
                List<WeixinMenuDto> secondWeixinMenuDtos = apiWeixinMenuPoService.wrapDtos(apiWeixinMenuPoService.getChildren(rootWeixinMenuDto.getId()));

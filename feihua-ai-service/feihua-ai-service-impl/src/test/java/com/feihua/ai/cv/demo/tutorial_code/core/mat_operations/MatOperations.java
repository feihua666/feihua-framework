package com.feihua.ai.cv.demo.tutorial_code.core.mat_operations;
...
public class MatOperations {
    ...
    public static void main(final String[] args) {
        ...
        // Memory management and reference counting
        {
            ...
            Mat img = Imgcodecs.imread("D:\\program-files\\opencv\\sources\\samples\\data\\lena.jpg");
            Mat img1 = img.clone();
            //! [Reference counting 2]
        }
        {
        ...
        {
            //! [BGR to Gray]
            Mat img = Imgcodecs.imread("D:\\program-files\\opencv\\sources\\samples\\data\\lena.jpg"); // loading a 8UC3 image
            Mat grey = new Mat();

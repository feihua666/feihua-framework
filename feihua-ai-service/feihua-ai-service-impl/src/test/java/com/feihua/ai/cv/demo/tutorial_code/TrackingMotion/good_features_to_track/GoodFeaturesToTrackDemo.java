package com.feihua.ai.cv.demo.tutorial_code.TrackingMotion.good_features_to_track;
...
class GoodFeaturesToTrack {
    ...
    public GoodFeaturesToTrack(String[] args) {
        ...
        String filename = args.length > 0 ? args[0] : "D:\\program-files\\opencv\\sources\\samples\\data\\pic3.png";

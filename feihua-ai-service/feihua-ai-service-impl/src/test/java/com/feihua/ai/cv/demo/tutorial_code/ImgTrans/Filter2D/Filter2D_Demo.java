package com.feihua.ai.cv.demo.tutorial_code.ImgTrans.Filter2D; /**
...
class Filter2D_DemoRun {
    ...
    public void run(String[] args) {
        ...
        //! [load]
        String imageName = ((args.length > 0) ? args[0] : "D:\\program-files\\opencv\\sources\\samples\\data\\lena.jpg");

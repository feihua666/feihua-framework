package com.feihua.ai.cv.demo.tutorial_code.ml.introduction_to_pca;
...
class IntroductionToPCA {
    ...
    public void run(String[] args) {
        //! [pre-process]
        // Load image
        String filename = args.length > 0 ? args[0] : "D:\\program-files\\opencv\\sources\\samples\\data\\pca_test1.jpg";

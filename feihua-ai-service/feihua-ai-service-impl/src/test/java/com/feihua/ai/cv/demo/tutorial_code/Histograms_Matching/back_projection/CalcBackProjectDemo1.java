package com.feihua.ai.cv.demo.tutorial_code.Histograms_Matching.back_projection;
...
class CalcBackProject1 {
    ...
    public CalcBackProject1(String[] args) {
        ...
        Mat src = Imgcodecs.imread("D:\\program-files\\opencv\\sources\\samples\\data\\apple.jpg");
        if (src.empty()) {

package com.feihua.ai.cv.demo.tutorial_code.ImgTrans.canny_detector;
...
public class CannyDetectorDemo {
    ...
    public CannyDetectorDemo(String[] args) {
        String imagePath = args.length > 0 ? args[0] : "D:\\program-files\\opencv\\sources\\samples\\data\\fruits.jpg";

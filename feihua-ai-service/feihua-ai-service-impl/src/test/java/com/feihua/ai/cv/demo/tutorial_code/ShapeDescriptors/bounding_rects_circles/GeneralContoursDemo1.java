package com.feihua.ai.cv.demo.tutorial_code.ShapeDescriptors.bounding_rects_circles;
...
class GeneralContours1 {
    ...
    public GeneralContours1(String[] args) {
        //! [setup]
        /// Load source image
        String filename = args.length > 0 ? args[0] : "D:\\program-files\\opencv\\sources\\samples\\data\\stuff.jpg";

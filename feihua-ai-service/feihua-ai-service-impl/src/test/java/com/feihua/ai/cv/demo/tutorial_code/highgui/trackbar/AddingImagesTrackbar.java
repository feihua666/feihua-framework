package com.feihua.ai.cv.demo.tutorial_code.highgui.trackbar;
...
public class AddingImagesTrackbar {
    ...
    public AddingImagesTrackbar(String[] args) {
        //! [load]
        String imagePath1 = "D:\\program-files\\opencv\\sources\\samples\\data\\LinuxLogo.jpg";
        String imagePath2 = "D:\\program-files\\opencv\\sources\\samples\\data\\/WindowsLogo.jpg";
        if (args.length > 1) {
            imagePath1 = args[0];
            imagePath2 = args[1];
        }

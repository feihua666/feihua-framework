package com.feihua.ai.cv.demo.tutorial_code.TrackingMotion.generic_corner_detector;
...
class CornerDetector {
    ...
    public CornerDetector(String[] args) {
        ...
        String filename = args.length > 0 ? args[0] : "D:\\program-files\\opencv\\sources\\samples\\data\\building.jpg";

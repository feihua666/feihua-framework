package com.feihua.ai.cv.demo.tutorial_code.ImgTrans.distance_transformation;
...
class ImageSegmentation {
    public void run(String[] args) {
        //! [load_image]
        // Load the image
        //String filename = args.length > 0 ? args[0] : "D:\\program-files\\opencv\\sources\\samples\\data\\cards.png";
        String filename = args.length > 0 ? args[0] : "D:\\program-files\\opencv\\sources\\samples\\data\\lena.jpg";
